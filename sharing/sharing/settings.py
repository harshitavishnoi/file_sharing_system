...
SECRET_KEY = "django-insecure-cg14oljopuhq!108fd(7u-0nz^&3v5_t891vpe)+3xje8ixxt9"
...
DATABASES = {
    "default": {
        ...
        'NAME': 'sharing',
        'USER': 'root',
        'PASSWORD': 'harshita@2001',
        'HOST': 'localhost',  # Assuming the database is on the same machine. Change if needed.
